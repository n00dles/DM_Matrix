 function EAL() {
     ...
     t.advanced_buttons = [
         ['new_document', 'newdocument.png', 'new_document', false],
 ...
 EAL.prototype = {
     ...
     get_button_html: function (id, img, exec, isFileSpecific, baseURL) {
         ...
         html += '<img id="' + id + '" src="' + baseURL + 'images/' + img + '" title="{$' + id + '}" width="16" height="16" class="editAreaButtonNormal" onmouseover="editArea.switchClass(this,\'editAreaButtonOver\');" onmouseout="editArea.restoreClass(this);" onmousedown="editArea.restoreAndSwitchClass(this,\'editAreaButtonDown\');" /></a>';
         return html;
     },
